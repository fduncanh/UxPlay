                       ...
                       char **response_data, int *response_datalen)
{
    ...
    char* hkpVersion = http_request_get_header(request, "X-Apple-HKP");
    ...
    if (hkpVersion == NULL) {
        ...
        *response_data = malloc(sizeof(public_key));
        ...
        logger_log(conn->raop->logger, LOGGER_ERR, "PAIRING: Unimplemented HomeKit pairing version: %s", hkpVersion);
    }
}
