    ...
    while (1) {
		...
		*/
		...
		/* test for a H265 VPS/SPS/PPS */
		        ...
		        logger_log(raop_rtp_mirror->logger, LOGGER_ERR, "invalid new codec H265: codec was set previously");
                        /* drop connection */
                        conn_reset = true;
                        break;
                    }
		    ...
		    pps_size = byteutils_get_short_be(ptr, 3);
		        ...
		        logger_log(raop_rtp_mirror->logger, LOGGER_ERR, "invalid new codec H264: codec was set previously");
                        /* drop connection */
                        conn_reset = true;
                        break;
                    }
